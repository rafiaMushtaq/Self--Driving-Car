...
public class SimpleDriver extends Controller{
	...
	public static void saveRecord(String getSpeed, String getAngleToTrackAxis,
	 ...
	 String getRPM, String getZSpeed,String getZ,String accelerate,String steering,String gear)
	{
		try
		{
			
            FileOutputStream fosState= new FileOutputStream("StateDriveFile.csv",true);
            PrintWriter pwState =new PrintWriter(fosState); 
            pwState.println(getSpeed+","+getAngleToTrackAxis+","+getTrackPosition+","+getGear+","+getRacePosition+","
			+getLateralSpeed+","+getCurrentLapTime+","+getDamage+","+getDistanceFromStartLine+","+getDistanceRaced+","
			+getFuelLevel+","+getLastLapTime+","+getRPM+","+getZSpeed+","+getZ+","+accelerate+","+steering+","+gear);
	...
	public Action control(SensorModel sensors){
	    ...
	    if (stuck > stuckTime)
	    {
			...
			///////////////////////////////////////////////////////////////////////////////
				...
				saveRecord( String.valueOf(sensors.getSpeed()),  String.valueOf(sensors.getAngleToTrackAxis()),
	  String.valueOf(sensors.getTrackPosition()),  Integer.toString(sensors.getGear()),
	  Integer.toString(sensors.getRacePosition()),
	  String.valueOf(sensors.getLateralSpeed()),
	  String.valueOf(sensors.getCurrentLapTime()),  String.valueOf(sensors.getDamage()),
	  String.valueOf(sensors.getDistanceFromStartLine()),  String.valueOf(sensors.getDistanceRaced()), 
	  String.valueOf(sensors.getFuelLevel()) 
	 ,  String.valueOf(sensors.getLastLapTime()),
	  String.valueOf(sensors.getRPM()),  String.valueOf(sensors.getZSpeed()), String.valueOf(sensors.getZ()),
	  String.valueOf(action.accelerate), String.valueOf(action.steering),
	  Integer.toString(action.gear));
		//////////////////////////////////////////////////////////	
